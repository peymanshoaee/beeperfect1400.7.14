...
public interface UserService  {
    ...
    MainConsoleResponse createUser(String username, String password, boolean enabled, String firstName, String lastName, String nickName, MultipartFile imageFile ) throws ServiceException, IOException;
